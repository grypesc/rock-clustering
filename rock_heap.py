...
class RockClustering:
    ...
    sparse matrix (Scipy lil_matrix) but this will slow down the algorithm. Rock heap is based on heapq
    library and is slower than my default, sorted list approach"""
